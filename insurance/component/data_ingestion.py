...
class DataIngestion:
    ...
    def download_insurance_data(self,):
        try:
            ...
            insurance_file_name = "insurance.zip"
            ...
            logging.info(
                f"File :[{zip_file_path}] has been downloaded successfully.")
    ...
    def split_data_as_train_test(self,) -> DataIngestionArtifact:
        try:
            ...
            for train_index, test_index in split.split(insurance_data_frame, insurance_data_frame["bmi_cat"]):
                strat_train_set = insurance_data_frame.loc[train_index].drop(
                    ["bmi_cat"], axis=1)
                strat_test_set = insurance_data_frame.loc[test_index].drop(
                    ["bmi_cat"], axis=1)
